import { IoKeyOutline, IoSnowOutline } from "react-icons/io5"; //new
...
import { MdOutlineBedroomParent, MdCabin, MdOutlinePark } from "react-icons/md"; //private rooms //cabins
...
const Filters = () => {
	const sorting: FilterIcons = [
		...
		{ title: "Parks", icon: <MdOutlinePark /> },
